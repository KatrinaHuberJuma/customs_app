...
resourcename="basicdemocustoms3"  # lower case, only
resourcegroup="basicdemocustoms3_rg"
...
# git clone https://github.com/apilogicserver/basicdemocustoms3.git
# cd basicdemocustoms3
...
az group create --name basicdemocustoms3_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group basicdemocustoms3_rg --sku S1 --is-linux
az container create --resource-group basicdemocustoms3_rg --name basicdemocustoms3 --image apilogicserver/basicdemocustoms3:latest --dns-name-label basicdemocustoms3 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//basicdemocustoms3.westus.azurecontainer.io:5656'
