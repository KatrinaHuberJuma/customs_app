...
api_logic_server__version = '16.01.30'
api_logic_server_created__on = 'February 17, 2026 20:48:03'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 16.01.30\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 16.01.30\n'
    msg += f'.. startup message: {start_up_message}\n'
